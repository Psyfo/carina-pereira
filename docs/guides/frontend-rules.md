...
12. [Documentation Organization](#documentation-organization)
...
> **⚠️ IMPORTANT**: Documentation must be organized by responsibility in subdirectories with lowercase, hyphenated naming.

### ✅ Always Follow

1. **Directory Structure**

   All documentation goes in `docs/` with subdirectories by responsibility:

   ```
   docs/
   ├── README.md               # Documentation index
   ├── admin/                  # Admin dashboard & backend
   ├── branding/               # Brand guidelines & design
   ├── guides/                 # Development guides & rules
   ├── promotions/             # Marketing & campaigns
   └── styles/                 # CSS architecture & styling
   ```
...
2. **File Naming Convention**
   ...
   ❌ WRONG: uppercase, underscores, or PascalCase
   - COLOR_SYSTEM.md
   - color_system.md
   - ColorSystem.md
   - BRAND.md
...
3. **Organization by Responsibility**
...
4. **Required Documentation Header**
   ...
   > **Purpose**: Brief description of what this document covers and who should read it
...
5. **Cross-Referencing Documents**
   ...
   ```markdown
   See [Color System](../styles/color-system.md) for details.
   Refer to [Brand Guidelines](../branding/brand-guidelines.md).
   Check [Frontend Rules](../guides/frontend-rules.md) before coding.
   ```

### ❌ Never Do

- **Don't create flat documentation structure** - Always use subdirectories
- **Don't use ALL CAPS filenames** - Use lowercase with hyphens
- **Don't mix naming conventions** - Stick to lowercase-with-hyphens
- **Don't create docs without a header** - Always include purpose statement
- **Don't skip the README.md** - Update `docs/README.md` when adding new docs
...
- **Brand Guidelines**: `docs/branding/brand-guidelines.md` - Brand consistency requirements
- **Frontend Rules**: `docs/guides/frontend-rules.md` - **⚠️ This file - REQUIRED reading**

### Styling

- **Color System**: `docs/styles/color-system.md` - Complete color palette guide
- **Color Reference**: `docs/styles/color-palette.md` - Visual color reference
- **Quick Reference**: `docs/styles/quick-reference.md` - CSS cheat sheet
- **CSS Architecture**: `src/styles/README.md` - Modular CSS structure

### Code

- **Components**: `src/components/` - Shared components
- **Page Components**: `src/app/(public)/components/` - Page-specific components
- **Types**: `src/types/` - TypeScript type definitions
- **API Routes**: `src/app/api/` - API endpoints
- **Models**: `src/models/` - Mongoose models

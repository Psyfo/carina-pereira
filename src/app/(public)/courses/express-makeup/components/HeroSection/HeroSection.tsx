...
const HeroSection: React.FC = () => {
  return (
    <motion.div
      ...
      className='relative hero-section w-full h-[80vh] md:h-[100vh] bg-[url("/images/courses/express-makeup/hero.png")] md:bg-[url("/images/courses/express-makeup/hero-md.png")] bg-cover bg-no-repeat bg-center'
    >
      <Link href='/'>
        <motion.div

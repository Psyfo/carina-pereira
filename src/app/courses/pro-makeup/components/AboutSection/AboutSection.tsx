...
const AboutSection: React.FC = () => {
  return (
    <section className='flex flex-col lg:flex-row lg:items-center lg:justify-center lg:gap-[125px] px-[25px] lg:px-[133px] py-[60px] lg:py-[120px]'>
      <div className='lg:w-[600px]'>
        <h1 className='font-tan-ashford font-bold tracking-wider'>
          about this course:
        </h1>
      ...
      <div className='lg:w-[550px] font-inclusive text-[15px] leading-[1.5] border border-black rounded-2xl px-[20] py-[30] mt-[84px] lg:mt-0'>

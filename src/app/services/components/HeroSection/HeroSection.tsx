...
const HeroSection: React.FC = () => {
  return (
    <div className='relative hero-section w-full h-[80vh] md:h-[100vh] bg-[url("/images/services/hero/hero.png")] md:bg-[url("/images/services/hero/hero-md.png")] bg-cover bg-no-repeat bg-center'>
      <Link href='/'>
        <Image

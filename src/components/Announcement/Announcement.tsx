...
const Announcement: React.FC = () => {
  return (
    <Link href='/courses/masterclass'>
      <div className='hidden top-0 right-0 left-0 z-40 absolute flex justify-center items-center bg-cpOrange px-4 py-2 md:py-0 md:h-[30px] min-h-[30px] text-white'>
